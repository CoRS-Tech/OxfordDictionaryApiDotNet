...
namespace OxfordDictionaryApiRapper.Serialisation.LexicalEntries.Entries
{
    public class Sense
    {
        ...
        public List<string> Definitions { get; internal set; } = new();
        ...
        public string GetFirstDefinition() => Definitions.Any()
            ? Definitions.FirstOrDefault() : Defaults.NoDefinitions;

        /// <summary>
        /// Gets the first example of this sense.
        /// </summary>
        /// <returns>Returns the example.</returns>
        public Example GetFirstExample() => Examples.Any() ? Examples.FirstOrDefault() :
            new Example
            {
